      ...
      <div>
        {sortingHat.length < 1 && (
          <>
            ...
            <img
              className={classes.GreatHallImage}
              src={GreatHall}
              alt="Welcom to Hogwarts"
            />
            <h2 className={classes.text}>
              Click the button below to decide what house to join!
            </h2>
          </>
        )}
        ...
        {sortingHat === "Gryffindor" && (
          <>
            ...
            <img
              ...
              src={Gryffindorbanner}
              alt="Welcome to Gryffindor!"
            />
          </>
        )}
        ...
        {sortingHat === "Hufflepuff" && (
          <>
            ...
            <img
              className={classes.banner}
              src={Hufflepuffbanner}
              alt="Welcome to Hufflepuff!"
            />
          </>
        )}
        <button className={classes.button} onClick={getSortingHat}>
          {sortingHat.length < 1 ? "What House are you in?" : "Try Again"}
        </button>
      </div>
